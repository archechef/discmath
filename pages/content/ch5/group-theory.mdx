...
3. $\text{im} h$ is the so-called **image** of the map $h$. Again you might have heard about a concept like this in linear algebra. It is simply the set of all elements we can possibly get as an output:
$$
